const copy = {
  ...
  aboutMe: {
    ...
    body: `Libero non cum aperiam dolor voluptate in sed illo. Repellat est soluta similique ipsa. Omnis aut quasi beatae quaerat deleniti suscipit. Aut ratione pariatur ratione quas. Quam rem omnis nihil officia non.`,
    techIntro: `My favorite technologies include:`,
    techBody: ['React', 'HTML', 'CSS'],
  },
  contactMe: {
    title: `Contact me`,
